...
e?0:e;f=void 0===f?2*Math.PI:f;ctx.save();ctx.translate(a+.5,b+.5);ctx.fillStyle=d;ctx.beginPath();ctx.arc(a,b,c,e,f);ctx.fill();ctx.restore()},DrawSprite=function(a,b,c,d,e,f){f=void 0===f?0:f;d=a.width*(void 0===d?1:d);e=a.height*(void 0===e?1:e);ctx.save();ctx.translate(b,c);ctx.rotate(f*Deg2Rad);ctx.drawImage(a,.5*-d,.5*-e,d,e);ctx.restore()},DrawText=function(a,b,c,d,e,f,g,h,k,l,m,n){d=void 0===d?12:d;e=void 0===e?"#FFF":e;f=void 0===f?0:f;g=void 0===g?"Arial":g;h=void 0===h?"":h;k=void 0===
k?"left":k;l=void 0===l?"bottom":l;m=void 0===m?0:m;n=void 0===n?"#000":n;ctx.save();ctx.translate(b,c);ctx.rotate(f*Deg2Rad);ctx.font=h+" "+d+"px "+g;ctx.fillStyle=e;ctx.textAlign=k;ctx.textBaseline=l;0<m&&(ctx.strokeStyle=n,ctx.lineWidth=m,ctx.lineJoin="round",ctx.strokeText(a,0,0));ctx.fillText(a,0,0);ctx.restore()},V2=function(a,b){this.x=void 0!=a?a:0;this.y=void 0!=b?b:0};V2.prototype.Set=function(a,b){this.x=a;this.y=b};V2.prototype.SetV=function(a){this.x=a.x;this.y=a.y};
V2.prototype.SetToFrom=function(a,b){this.x=b.x-a.x;this.y=b.y-a.y};V2.prototype.AddV=function(a){this.x+=a.x;this.y+=a.y};V2.prototype.SubV=function(a){this.x-=a.x;this.y-=a.y};V2.prototype.MulS=function(a){this.x*=a;this.y*=a};V2.prototype.DivS=function(a){this.x/=a;this.y/=a};V2.prototype.DistTo=function(a){return Math.sqrt(this.DistToSq(a))};V2.prototype.DistToSq=function(a){var b=this.x-a.x;a=this.y-a.y;return b*b+a*a};V2.prototype.Len=function(){return Math.sqrt(this.LenSq())};
V2.prototype.LenSq=function(){return this.x*this.x+this.y*this.y};V2.prototype.Normalize=function(){var a=this.Len();this.x/=a;this.y/=a};V2.prototype.ClampMax=function(a){var b=this.LenSq();b>a*a&&(b=Math.sqrt(b),this.x=this.x/b*a,this.y=this.y/b*a)};
