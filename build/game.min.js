...
z.buffer=M,z.start(),z};zzfxX=void 0;var V2=function(a,b){this.x=void 0!=a?a:0;this.y=void 0!=b?b:0};V2.prototype.Set=function(a,b){this.x=a;this.y=b};V2.prototype.SetV=function(a){this.x=a.x;this.y=a.y};V2.prototype.SetToFrom=function(a,b){this.x=b.x-a.x;this.y=b.y-a.y};V2.prototype.AddV=function(a){this.x+=a.x;this.y+=a.y};V2.prototype.SubV=function(a){this.x-=a.x;this.y-=a.y};V2.prototype.MulS=function(a){this.x*=a;this.y*=a};V2.prototype.DivS=function(a){this.x/=a;this.y/=a};
V2.prototype.DistTo=function(a){return Math.sqrt(this.DistToSq(a))};V2.prototype.DistToSq=function(a){var b=this.x-a.x;a=this.y-a.y;return b*b+a*a};V2.prototype.Len=function(){return Math.sqrt(this.LenSq())};V2.prototype.LenSq=function(){return this.x*this.x+this.y*this.y};V2.prototype.Normalize=function(){var a=this.Len();this.x/=a;this.y/=a};V2.prototype.ClampMax=function(a){var b=this.LenSq();b>a*a&&(b=Math.sqrt(b),this.x=this.x/b*a,this.y=this.y/b*a)};nextState=state=null;Enter=0;Tick=1;
Draw=2;Exit=3;clearColor="#2A2A2AFF";gameLoopFixedTimeStep=1/60;gameLoopFrameTimeAccum=0;previousGameLoopTime=void 0;
...
CreateEnemy=function(){for(var a=0,b=Math.random(),c=0;c<enemyFuncs.length;++c)if(a+=enemyFuncs[c].prob/enemyFuncsTotalProb,b<=a){enemyFuncs[c].func();break}};
DrawBackground=function(){PushMatrix(0,.25*-player.bellyOffset.y,0);DrawLine(100,280,810,280,"#3A50BD",15);DrawLine(100,280,-10,460,"#3A50BD",13.5);DrawLine(100,240,810,240,"#EDF7F7",15);DrawLine(100,240,-10,405,"#EDF7F7",13.5);DrawLine(100,200,810,200,"#CE3B2F",15);DrawLine(100,200,-10,355,"#CE3B2F",13.5);DrawLine(110,190,110,315,"#111",30);ctx.beginPath();ctx.moveTo(95,315);ctx.lineTo(15,460);ctx.lineTo(810,460);ctx.lineTo(810,315);ctx.closePath();ctx.fillStyle="#83839E";ctx.fill();ctx.beginPath();
ctx.moveTo(100,320);ctx.lineTo(25,460);ctx.lineTo(810,460);ctx.lineTo(810,320);ctx.closePath();ctx.fillStyle="#BFBEE5";ctx.fill();PopMatrix()};DrawHud=function(){for(var a=0;3>a;++a)DrawRect(40+40*a,40,20,20,player.health>a?"#F00":"#444");DrawText(player.score.toString(),gameWidth-40,50,40,"#FFF",0,"Arial","Bold","right","center",8)};var PlayerStateIdle=0,PlayerStateBelly=1,BellyBounceTime=45,BellyBounceAttackTime=8,Player=function(){this.Reset()};
Player.prototype.Reset=function(){this.Idle();this.health=3;this.score=0;this.bellyOffset=new V2(0,0);this.bellyOffset.xLast=0;this.bellyOffset.yLast=0};Player.prototype.Tick=function(){switch(this.state){case PlayerStateIdle:touch.down&&this.BellyBounce();break;case PlayerStateBelly:this.timer--,0==this.timer&&this.Idle(),touch.down&&this.hitConfirm&&this.BellyBounce()}this.UpdateBellyPhysics()};
Player.prototype.Idle=function(){this.pos=new V2(200,280);this.timer=this.angle=0;this.hitConfirm=!1;this.state=PlayerStateIdle};Player.prototype.BellyBounce=function(){this.bellyOffset.x=5;this.bellyOffset.y=10;this.timer=BellyBounceTime;this.state=PlayerStateBelly};Player.prototype.IsBellyBounceAttacking=function(){return this.state==PlayerStateBelly&&this.timer>=BellyBounceTime-BellyBounceAttackTime};Player.prototype.OnBounce=function(a){this.timer=15;this.hitConfirm=!0;this.score++};
Player.prototype.OnHit=function(a){this.timer=15;this.health--;0==this.health&&(nextState=GameOver)};Player.prototype.UpdateBellyPhysics=function(){var a=this.bellyOffset.x-this.bellyOffset.xLast,b=this.bellyOffset.y-this.bellyOffset.yLast;this.bellyOffset.xLast=this.bellyOffset.x;this.bellyOffset.yLast=this.bellyOffset.y;this.bellyOffset.x+=a;this.bellyOffset.y+=b;a=this.bellyOffset.Len();0<a&&(a=(a-0)/a,a=new V2(this.bellyOffset.x*a*.2,this.bellyOffset.y*a*.2),this.bellyOffset.SubV(a))};
...
4,10,12,this.pupilColor),DrawRect(10,20,40,10,this.mouthColor)}PopMatrix()};
var EnemyStateMoveToPlayer=0,EnemyStateBounceOff=1,EnemyStyleLowerShorts=0,EnemyStyleLowerPants=1,EnemyStyleHeadNormal=0,EnemyFrameIdle=0,EnemyFrameRun01=1,EnemyFrameRun02=2,EnemyFrameRun03=3,EnemyFrameBounceOff=4,EnemyAnimIdle={frames:[EnemyFrameIdle],counts:[1]},EnemyAnimRun={frames:[EnemyFrameRun01,EnemyFrameRun02,EnemyFrameRun03,EnemyFrameRun02],counts:[9,9,9,9]},EnemyAnimBounceOff={frames:[EnemyFrameBounceOff],counts:[1]},Enemy=function(){this.pos=new V2(840,310);this.vel=new V2(0,0);this.state=
EnemyStateMoveToPlayer;this.angle=0;this.color="000";this.bounceThreshold=player.pos.x+80;this.damageThreshold=player.pos.x+10;this.bounceOffAngleAdj=0;this.styleLower=EnemyStyleLowerShorts;this.styleHead=EnemyStyleHeadNormal;this.frame=EnemyFrameBounceOff;this.skinColor="#DC774F";this.outlineColor="#A3583A";this.bootColor=this.outfitColor="#B00";this.lacesColor="#FFF";this.eyeColor="#000";this.SetAnim(EnemyAnimRun)};
...
120),this.DrawBody(0,0,0),this.DrawHead(-10,-60,0),this.DrawOutfit(0,0,0),this.DrawLeg(10,43,-70),this.DrawArm(20,-25,-120),PopMatrix()}PopMatrix()};Enemy.prototype.DrawBody=function(a,b,c){PushMatrix(a,b,c);DrawRect(-5,0,60,80,this.skinColor);PopMatrix()};Enemy.prototype.DrawOutfit=function(a,b,c){PushMatrix(a,b,c);switch(this.styleLower){case EnemyStyleLowerShorts:case EnemyStyleLowerPants:DrawRect(-5,35,60,30,this.outfitColor)}PopMatrix()};
...
Enemy.prototype.DrawHead=function(a,b,c){PushMatrix(a,b,c);DrawRect(0,0,50,50,this.skinColor);switch(this.styleHead){case EnemyStyleHeadNormal:DrawRect(-12,0,9,15,this.eyeColor),DrawRect(5,0,9,15,this.eyeColor)}PopMatrix()};Enemy.prototype.DrawArm=function(a,b,c){PushMatrix(a,b,c);DrawCircle(-1.5,1.5,19,this.outlineColor);DrawCircle(-1.5,13.5,12,this.outlineColor);DrawCircle(0,0,19,this.skinColor);DrawCircle(0,12,12,this.skinColor);PopMatrix()};
var Enemy_SlowRun=function(){Enemy.call(this);this.vel.Set(-12,0);this.color="#F00"};$jscomp.inherits(Enemy_SlowRun,Enemy);var Enemy_FastRun=function(){Enemy.call(this);this.vel.Set(-18,0);this.color="#600"};$jscomp.inherits(Enemy_FastRun,Enemy);var Enemy_SlowBounce=function(){Enemy.call(this);this.color="#00F";this.pos.Set(this.pos.x+140,this.pos.y);this.vel.Set(-10,-16)};$jscomp.inherits(Enemy_SlowBounce,Enemy);
Enemy_SlowBounce.prototype.MoveToPlayer=function(){this.vel.y+=.8;Enemy.prototype.MoveToPlayer.call(this);296<=this.pos.y&&(this.pos.y=296,this.vel.y=-16)};var Enemy_DelayedAttack=function(){Enemy.call(this);this.color="#0FF";this.vel.Set(-12,0);this.subTimer=this.subState=0};$jscomp.inherits(Enemy_DelayedAttack,Enemy);
...
var Enemy_LongJump=function(){Enemy.call(this);this.color="#FF0";this.pos.Set(this.pos.x+80,this.pos.y);this.vel.Set(-20,-20);this.angle=-10};$jscomp.inherits(Enemy_LongJump,Enemy);Enemy_LongJump.prototype.MoveToPlayer=function(){this.vel.y+=1;Enemy.prototype.MoveToPlayer.call(this);296<=this.pos.y&&(this.pos.y=296,this.vel.y=-18)};var player=new Player,objs=[];objs.push(player);var enemyTimer,touchDelay;
MainMenu=function(a){switch(a){case Tick:touch.down&&(nextState=GameState);break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawText("Menu",.5*gameWidth,.5*gameHeight,72,"#FFF",0,"Arial","Bold","center","center",12)}};GameState=function(a){switch(a){case Enter:player.Reset();enemyTimer=setInterval(function(){return CreateEnemy()},1500);break;case Tick:objs.forEach(function(a){return a.Tick()});break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawHud()}};
GameOver=function(a){switch(a){case Enter:touchDelay=60;clearInterval(enemyTimer);break;case Tick:touchDelay--;0>touchDelay&&touch.down&&(nextState=MainMenu);break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawHud(),DrawText("Game Over",.5*gameWidth,.5*gameHeight,72,"#FFF",0,"Arial","Bold","center","center",12)}};
RenderTest=function(a){switch(a){case Enter:player.Reset();CreateEnemy();objs[1].pos.x=600;objs[1].pos.y=300;break;case Tick:objs[1].Animate();break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawHud()}};nextState=GameState;window.addEventListener("keydown",function(a){"e"==a.key.toLowerCase()&&CreateEnemy()});