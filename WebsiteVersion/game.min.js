...
var gameWidth=800,gameHeight=450,gameScale=1,Deg2Rad=Math.PI/180,Rad2Deg=180/Math.PI,canvas=document.getElementById("canvas"),ctx=canvas.getContext("2d"),touch={x:0,y:0,up:!1,down:!1,held:!1,lastDown:1E4};canvas.addEventListener("mousedown",function(a){touch.up=!1;touch.down=!0;touch.held=!0;SetTouchPos(a);a.preventDefault()},{capture:!1,passive:!1});canvas.addEventListener("mouseup",function(a){touch.up=!0;touch.down=!1;touch.held=!1;a.preventDefault()},{capture:!1,passive:!1});
canvas.addEventListener("touchstart",function(a){touch.up=!1;touch.down=!0;touch.held=!0;SetTouchPos(a.touches[0]);a.preventDefault()},{capture:!1,passive:!1});canvas.addEventListener("touchend",function(a){touch.up=!0;touch.down=!1;touch.held=!1;a.preventDefault()},{capture:!1,passive:!1});canvas.addEventListener("touchcancel",function(a){touch.up=!0;touch.down=!1;touch.held=!1;a.preventDefault()},{capture:!1,passive:!1});
