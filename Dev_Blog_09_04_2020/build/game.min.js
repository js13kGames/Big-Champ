...
$jscomp.checkStringArgs=function(a,b,c){if(null==a)throw new TypeError("The 'this' value for String.prototype."+c+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+c+" must not be a regular expression");return a+""};$jscomp.polyfill("String.prototype.includes",function(a){return a?a:function(a,c){return-1!==$jscomp.checkStringArgs(this,a,"includes").indexOf(a,c||0)}},"es6","es3");gameWidth=800;gameHeight=450;gameScale=1;
Deg2Rad=Math.PI/180;Rad2Deg=180/Math.PI;canvas=document.createElement("canvas");canvas.setAttribute("width",gameWidth);canvas.setAttribute("height",gameHeight);canvas.style.width=gameWidth*gameScale+"px";canvas.style.height=gameHeight*gameScale+"px";document.getElementById("game").appendChild(canvas);ctx=this.canvas.getContext("2d");ctx.imageSmoothingEnabled=!1;touch={x:0,y:0,up:!1,down:!1,held:!1};canvas.addEventListener("mousedown",function(a){touch.up=!1;touch.down=!0;touch.held=!0},!1);
canvas.addEventListener("mouseup",function(a){touch.up=!0;touch.down=!1;touch.held=!1},!1);canvas.addEventListener("mousemove",function(a){SetTouchPos(a);a.preventDefault()},!1);canvas.addEventListener("touchstart",function(a){SetTouchPos(a.touches[0]);touch.up=!1;touch.down=!0;touch.held=!0;a.preventDefault()},!1);canvas.addEventListener("touchend",function(a){touch.up=!0;touch.down=!1;touch.held=!1;a.preventDefault()},!1);
canvas.addEventListener("touchcancel",function(a){touch.up=!0;touch.down=!1;touch.held=!1;a.preventDefault()},!1);canvas.addEventListener("touchmove",function(a){SetTouchPos(a.touches[0]);a.preventDefault()},!1);SetTouchPos=function(a){touch.x=(a.pageX-canvas.offsetLeft)/gameScale;touch.y=(a.pageY-canvas.offsetTop)/gameScale};PushMatrix=function(a,b,c){c=void 0===c?0:c;ctx.save();ctx.translate(a,b);ctx.rotate(c*Deg2Rad)};PopMatrix=function(){ctx.restore()};
LoadSprite=function(a){sprite=new Image;sprite.src=a;return sprite};DrawLine=function(a,b,c,d,e,f){f=void 0===f?1:f;ctx.save();ctx.strokeStyle=e;ctx.lineWidth=f;ctx.lineCap="round";ctx.beginPath();ctx.moveTo(a,b);ctx.lineTo(c,d);ctx.stroke();ctx.restore()};DrawBezierLine=function(a,b,c,d,e,f,l,p,n,q){ctx.save();ctx.strokeStyle=n;ctx.lineWidth=q;ctx.lineCap="round";ctx.beginPath();ctx.moveTo(a,b);ctx.bezierCurveTo(e,f,l,p,c,d);ctx.stroke();ctx.restore()};
DrawRect=function(a,b,c,d,e,f){f=void 0===f?0:f;c*=.5;d*=.5;ctx.save();ctx.translate(a+.5,b+.5);ctx.rotate(f*Deg2Rad);ctx.fillStyle=e;ctx.beginPath();ctx.moveTo(-c,-d);ctx.lineTo(c,-d);ctx.lineTo(c,d);ctx.lineTo(-c,d);ctx.lineTo(-c,-d);ctx.fill();ctx.restore()};DrawCircle=function(a,b,c,d,e,f){e=void 0===e?0:e;f=void 0===f?2*Math.PI:f;ctx.save();ctx.translate(a+.5,b+.5);ctx.fillStyle=d;ctx.beginPath();ctx.arc(a,b,c,e,f);ctx.fill();ctx.restore()};
DrawSprite=function(a,b,c,d,e,f){f=void 0===f?0:f;d=a.width*(void 0===d?1:d);e=a.height*(void 0===e?1:e);ctx.save();ctx.translate(b,c);ctx.rotate(f*Deg2Rad);ctx.drawImage(a,.5*-d,.5*-e,d,e);ctx.restore()};
DrawText=function(a,b,c,d,e,f,l,p,n,q,r){d=void 0===d?12:d;e=void 0===e?"#FFF":e;f=void 0===f?0:f;l=void 0===l?"Arial":l;p=void 0===p?"":p;n=void 0===n?"left":n;q=void 0===q?"bottom":q;r=void 0===r?0:r;ctx.save();ctx.translate(b,c);ctx.rotate(f*Deg2Rad);ctx.font=p+" "+d+"px "+l;ctx.fillStyle=e;ctx.textAlign=n;ctx.textBaseline=q;0<r&&(ctx.strokeStyle="#000",ctx.lineWidth=r,ctx.lineJoin="round",ctx.strokeText(a,0,0));ctx.fillText(a,0,0);ctx.restore()};zzfxV=.3;
zzfx=function(a,b,c,d,e,f,l,p,n,q,r,N,C,x,D,O,R,A,S,h,u,E,F,y,t,m,G,v,P,H,Q,I,J,g,K,L,k,w,B,z,M){a=void 0===a?1:a;b=void 0===b?.05:b;c=void 0===c?220:c;l=void 0===l?0:l;p=void 0===p?1:p;n=void 0===n?0:n;q=void 0===q?0:q;r=void 0===r?0:r;N=void 0===N?0:N;C=void 0===C?0:C;x=void 0===x?0:x;D=void 0===D?0:D;O=void 0===O?0:O;A=void 0===A?1:A;h=void 0===h?44100:h;u=void 0===u?99+(void 0===d?0:d)*h:u;E=void 0===E?(void 0===e?0:e)*h:E;F=void 0===F?(void 0===f?.1:f)*h:F;y=void 0===y?(void 0===S?0:S)*h:y;t=
...
GameLoop=function(a){window.requestAnimationFrame(GameLoop);for(gameLoopFrameTimeAccum+=Math.min((a-(previousGameLoopTime||a))/1E3,.2);gameLoopFrameTimeAccum>gameLoopFixedTimeStep;)gameLoopFrameTimeAccum-=gameLoopFixedTimeStep,null!=nextState&&(null!=state&&state(Exit),state=nextState,nextState=null,null!=state&&state(Enter)),state&&state(Tick),touch.up=!1,touch.down=!1;ctx.rect(0,0,gameWidth,gameHeight);ctx.fillStyle=clearColor;ctx.fill();state&&state(Draw);previousGameLoopTime=a};window.requestAnimationFrame(GameLoop);
enemySpawnInfo=[];enemySpawnInfo.push({maxPlayerScore:0,possibleEnemyTypes:[0],minSpawnCount:1,maxSpawnCount:1,minSpawnDelay:0,maxSpawnDelay:0,minNextDelay:2,maxNextDelay:2.5});enemySpawnInfo.push({maxPlayerScore:3,possibleEnemyTypes:[0,1,2],minSpawnCount:1,maxSpawnCount:1,minSpawnDelay:0,maxSpawnDelay:0,minNextDelay:2,maxNextDelay:2});enemySpawnInfo.push({maxPlayerScore:6,possibleEnemyTypes:[0,2,3],minSpawnCount:2,maxSpawnCount:2,minSpawnDelay:1.5,maxSpawnDelay:2,minNextDelay:1.25,maxNextDelay:1.5});
enemySpawnInfo.push({maxPlayerScore:8,possibleEnemyTypes:[4],minSpawnCount:1,maxSpawnCount:1,minSpawnDelay:0,maxSpawnDelay:0,minNextDelay:1.25,maxNextDelay:1.5});enemySpawnInfo.push({maxPlayerScore:15,possibleEnemyTypes:[0,0,1,1,2,2,3,3,4],minSpawnCount:2,maxSpawnCount:2,minSpawnDelay:.75,maxSpawnDelay:1,minNextDelay:1.5,maxNextDelay:1.75});enemySpawnInfo.push({maxPlayerScore:20,possibleEnemyTypes:[3,3,4,4],minSpawnCount:2,maxSpawnCount:2,minSpawnDelay:1,maxSpawnDelay:1.25,minNextDelay:1.5,maxNextDelay:1.75});
enemySpawnInfo.push({maxPlayerScore:25,possibleEnemyTypes:[0,1,2,3,4],minSpawnCount:2,maxSpawnCount:3,minSpawnDelay:.5,maxSpawnDelay:.75,minNextDelay:1.75,maxNextDelay:1.75});enemySpawnInfo.push({maxPlayerScore:35,possibleEnemyTypes:[1,2,3,4],minSpawnCount:2,maxSpawnCount:2,minSpawnDelay:.4,maxSpawnDelay:.6,minNextDelay:1.35,maxNextDelay:1.35});
enemySpawnInfo.push({maxPlayerScore:50,possibleEnemyTypes:[0,1,2,3,4],minSpawnCount:3,maxSpawnCount:4,minSpawnDelay:.3,maxSpawnDelay:.5,minNextDelay:1.15,maxNextDelay:1.25});enemySpawnInfo.push({maxPlayerScore:100,possibleEnemyTypes:[0,1,2,3,4],minSpawnCount:4,maxSpawnCount:6,minSpawnDelay:.25,maxSpawnDelay:.45,minNextDelay:1.1,maxNextDelay:1.2});enemyIdxBag=[];testScore=lastSpawnInfoIdx=-1;
CreateEnemy=function(){for(var a=0;a<enemySpawnInfo.length;++a){var b=enemySpawnInfo[a];void 0!=testScore&&0<testScore&&(player.score=testScore);if(player.score<=b.maxPlayerScore||a==enemySpawnInfo.length-1){a!=lastSpawnInfoIdx&&(lastSpawnInfoIdx=a,enemyIdxBag=[]);a=b.minSpawnCount+Math.floor(Math.random()*(b.maxSpawnCount-b.minSpawnCount)+.5);for(var c=0,d=0;d<a;++d){var e=-1;do e=Math.floor(Math.random()*b.possibleEnemyTypes.length);while(enemyIdxBag.includes(e));enemyIdxBag.push(e);enemyIdxBag.length==
...
PlayEnemySpawnSFX()},1E3*c)}c+=b.minSpawnDelay+Math.random()*(b.maxSpawnDelay-b.minSpawnDelay)}enemyTimer=setTimeout(CreateEnemy,1E3*(c+(b.minNextDelay+Math.random()*(b.maxNextDelay-b.minNextDelay))));break}}};PlayEnemySpawnSFX=function(){zzfx.apply(null,[,,90,.01,,.09,,2.92,,-43,53,.01,.01,,,,,.74,.02])};crowd=[];crowdColors="#331C16 #400101 #2A110A #28251E #152833 #333015 #06280D".split(" ");
for(var i=0;300>i;++i)crowd.push({x:Math.random()*gameWidth,y:Math.random()*gameHeight*.5,col:Math.floor(Math.random()*crowdColors.length),off:Math.random(),spd:.003*Math.random()});flashes=[];nextFlashTime=Math.floor(100*Math.random());
...
Player.prototype.Tick=function(){switch(this.state){case PlayerStateIdle:touch.down&&state!=RenderTest&&this.BellyBounce();break;case PlayerStateBelly:this.timer--;0==this.timer&&this.Idle();touch.down&&this.hitConfirm&&this.BellyBounce();break;case PlayerStateHit:this.timer--;0==this.timer&&(0==this.health?(this.bellyOffset.x=10,this.bellyOffset.y=10,nextState=GameOver,this.state=PlayerStateDead,zzfx.apply(null,[,,56,,.08,.46,3,2.52,,,,,,1.7,.7,.1,,.62,.01])):this.Idle());break;case PlayerStateIntro:this.pos.Set(this.pos.x,
280-this.timer/22*560),this.timer--,0==this.timer&&(this.Idle(),this.bellyOffset.xLast=0,this.bellyOffset.yLast=0,this.bellyOffset.x=5,this.bellyOffset.y=15,zzfx.apply(null,[,,309,,.02,.32,2,.47,,,,,,1.1,.7,,.15,.99,.09]),zzfx.apply(null,[,,511,.31,.1,1.75,4,2.74,.6,.6,,,,.7,,.2,,.75,.09]))}this.UpdateBellyPhysics()};Player.prototype.Idle=function(){this.pos=new V2(200,280);this.timer=this.angle=0;this.hitConfirm=!1;this.state=PlayerStateIdle};
Player.prototype.Intro=function(){this.pos.Set(200,-280);this.timer=22;this.state=PlayerStateIntro;zzfx.apply(null,[,,806,.05,.08,.47,2,.62,-2.8,3.1,,,,,,,.04,.63,.01])};Player.prototype.BellyBounce=function(){this.hitConfirm=!1;this.bellyOffset.xLast=0;this.bellyOffset.yLast=0;this.bellyOffset.x=15;this.bellyOffset.y=15;this.timer=BellyBounceTime;this.state=PlayerStateBelly;zzfx.apply(null,[,,596,.05,,.09,1,.18,,-2.7,-4,.17,.11,,-2.1,,.1,,.02])};
Player.prototype.IsBellyBounceAttacking=function(){return this.state==PlayerStateBelly&&(this.timer>=BellyBounceTime-BellyBounceAttackTime||this.hitConfirm&&7<=this.timer)};
Player.prototype.OnBounce=function(a){this.timer=15;this.hitConfirm=!0;this.score++;a=localStorage.getItem("bigchamp.highscore");if(null==a||a<this.score)localStorage.setItem("bigchamp.highscore",this.score),this.isHighScore=!0;zzfx.apply(null,[,,235,,,.12,,.15,-4.2,-6.7,,,,1.4,,.1,,.85,.04]);0==this.score%10&&zzfx.apply(null,[,,714,.38,.15,1,4,4.72,.7,.2,,,,.1,.9,.2,,.89])};
...
$jscomp.inherits(Enemy_LongJump,Enemy);Enemy_LongJump.prototype.MoveToPlayer=function(){this.vel.y+=1;Enemy.prototype.MoveToPlayer.call(this);296<=this.pos.y&&(this.pos.y=296,this.vel.y=-18);this.angle-=10};var player=new Player,objs=[];objs.push(player);var enemyTimer,touchDelay;TouchState=function(a){switch(a){case Tick:touch.down&&(CreateAudioContext(),nextState=MainMenu);break;case Draw:DrawText("Tap To Start",.5*gameWidth,.5*gameHeight,36,"#FFF",0,"Arial","Bold","center","center",12)}};
MainMenu=function(a){switch(a){case Tick:touch.down&&(nextState=IntroState);break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawText("Menu",.5*gameWidth,.3*gameHeight,72,"#FFF",0,"Arial","Bold","center","center",12)}};
...
GameOver=function(a){switch(a){case Enter:clearTimeout(enemyTimer);gameOverState=0;gameOverTimer=setInterval(function(){10>gameOverState&&gameOverState++},350);break;case Exit:clearInterval(gameOverTimer);break;case Tick:8<=gameOverState&&touch.down&&(nextState=MainMenu);objs.forEach(function(a){return a.Tick()});break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),2<=gameOverState&&DrawText("Game Over",.5*gameWidth,.3*gameHeight,72,"#DB0000",0,"Arial","Bold","center","center",
12),4<=gameOverState&&DrawText("Eliminations: "+player.score,.5*gameWidth,.4*gameHeight,36,"#FFF",0,"Arial","Bold","center","center",8),6<=gameOverState&&(a=localStorage.getItem("bigchamp.highscore"),null==a&&(a=0),DrawText("Best: "+a,.5*gameWidth,.48*gameHeight,36,"#FFF",0,"Arial","Bold","center","center",8)),8<=gameOverState&&player.isHighScore&&DrawText("New Best!",.5*gameWidth,.6*gameHeight,36+10*Math.abs(Math.sin(.005*Date.now())),"#04D84E",-10,"Arial","Bold","center","center",10)}};
RenderTest=function(a){switch(a){case Enter:player.Reset();CreateEnemy();objs[1].pos.x=600;objs[1].pos.y=300;objs[1].SetAnim(EnemyAnimJump);break;case Tick:player.Tick();touch.down&&(player.state++,player.state>PlayerStateDead&&(player.state=PlayerStateIdle));objs[1].Animate();break;case Draw:DrawBackground(),objs.forEach(function(a){return a.Draw()}),DrawHud()}};nextState=TouchState;window.addEventListener("keydown",function(a){"e"==a.key.toLowerCase()&&CreateEnemy()});